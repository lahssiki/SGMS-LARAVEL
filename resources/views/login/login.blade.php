          ...
          <div class="card-body p-3 text-center">
            ...
            <div class="mb-md-2 mt-md-4 pb-2">
              ...
              <div data-mdb-input-init class="form-outline form-white mb-4">
                ...
                <label class="form-label" for="email"  placeholder="name@example.com" required >Email</label>
              </div>

              <div data-mdb-input-init class="form-outline form-white mb-4">
                <input type="password" name="password" id="password" class="form-control form-control-lg" />
                <label class="form-label" for="password" placeholder="Password">Password</label>
              </div>

              <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="#!">Forgot password?</a></p>

              <button data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-light btn-lg px-5">Login</button>
                </form>
            </div>
          </div>
        </div>
